...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nl5atpm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nl5atpm.containers.anotherwebservice.com/
...
```
git clone git@github.com:rohitr1981/container-nl5atpm.git
cd container-nl5atpm
```
...
```
docker attach container-nl5atpm
```
